...
import { DEFAULT_STATUS_COLORS, BRAND_COLORS } from '@/lib/constants';
import { 
  PointerSensor, 
  KeyboardSensor, 
  useSensor, 
...
export default function NextJsDashboard() {
  ...
  const [sequencerOrderIds, setSequencerOrderIds] = useState<number[]>([]);
  ...
  const getGroupPrefix = (tacticalName: string, tasks: TaskItem[], currentTaskId?: number | null) => {
